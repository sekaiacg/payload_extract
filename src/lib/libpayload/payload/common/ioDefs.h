#ifndef PAYLOAD_EXTRACT_IODEFS_H
#define PAYLOAD_EXTRACT_IODEFS_H
...
#define payload_fallocate fallocate64
#else
#define payload_fallocate fallocate
#endif
#else
#define payload_fallocate(...) (-1)
#endif
...
#endif //PAYLOAD_EXTRACT_IODEFS_H
